Ansible Role: OS-Windows2019/WIN_ErrorReporting/OS_build
=======================================================
# Description
本ロールは、Windows Server 2019に関するエラーレポーティング設定についての情報の設定を行います。
...
OS-Windows2019/WIN_ErrorReporting/OS_gatheringロールを利用します。
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-Windows2019/WIN_ErrorReporting/OS_build
      VAR_WIN_ErrorReporting:
      - Key: HKLM:\SOFTWARE\Microsoft\Windows\Windows Error Reporting
        Values:
        - Action: present
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-Windows2019/WIN_ErrorReporting/OS_gathering
  strategy: free
~~~
