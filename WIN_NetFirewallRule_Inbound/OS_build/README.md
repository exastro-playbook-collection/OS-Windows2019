Ansible Role: OS-Windows2019/WIN_NetFirewallRule_Inbound/OS_build
=======================================================
# Description
本ロールは、Windows Server 2019に関するファイアウォール設定（受信規則）についての情報の設定を行います。
...
OS-Windows2019/WIN_NetFirewallRule_Inbound/OS_gatheringロールを利用します。
