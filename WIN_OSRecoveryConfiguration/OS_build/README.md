Ansible Role: OS-Windows2019/WIN_OSRecoveryConfiguration/OS_build
=======================================================
# Description
本ロールは、Windows Server 2019に関するWindows詳細情報（起動と回復）についての情報の設定を行います。
...
OS-Windows2019/WIN_OSRecoveryConfiguration/OS_gatheringロールを利用します。
