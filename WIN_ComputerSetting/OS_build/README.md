Ansible Role: OS-Windows2019/WIN_ComputerSetting/OS_build
=======================================================
# Description
本ロールは、Windows Server 2019に関するWindows基本設定（コンピュータ名）についての情報の設定を行います。
...
OS-Windows2019/WIN_ComputerSetting/OS_gatheringロールを利用します。
...
VAR_WIN_ComputerSetting:
  ...
  Description: AWS Win2019-01 TEST
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-Windows2019/WIN_ComputerSetting/OS_build
      VAR_WIN_ComputerSetting:
        DNSDomainSuffixSearchOrder: ''
        Description: AWS Win2019-01 TEST
        DomainOrWorkgroup: false
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-Windows2019/WIN_ComputerSetting/OS_gathering
  strategy: free
~~~
