Ansible Role: OS-Windows2019/WIN_NetworkDrive/OS_build
=======================================================
# Description
本ロールは、Windows Server 2019に関するネットワークドライブ設定についての情報の設定を行います。
...
OS-Windows2019/WIN_NetworkDrive/OS_gatheringロールを利用します。
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-Windows2019/WIN_NetworkDrive/OS_build
      VAR_WIN_NetworkDrive:
      - Action: present
        Name: Z
        Password: Passw0rd123
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-Windows2019/WIN_NetworkDrive/OS_gathering
  strategy: free
~~~
