Ansible Role: OS-Windows2019/WIN_VolumeSetting/OS_gathering
=======================================================
# Description
本ロールは、Windows Server 2019に関するディスク管理についての情報の取得を行います。
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-Windows2019/WIN_VolumeSetting/OS_gathering
  strategy: free
~~~
