Ansible Role: OS-Windows2019/WIN_DataCollectorSet/OS_build
=======================================================
# Description
本ロールは、Windows Server 2019に関するデータコレクタについての情報の設定を行います。
...
OS-Windows2019/WIN_DataCollectorSet/OS_gatheringロールを利用します。
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-Windows2019/WIN_DataCollectorSet/OS_build
      VAR_WIN_DataCollectorSet:
      - path: C:\Users\ansible\Server Manager Performance Monitor.xml
        text:
        - <DataCollectorSet>
...
- hosts: all
  gather_facts: true
  roles:
    - role: OS-Windows2019/WIN_DataCollectorSet/OS_gathering
  strategy: free
~~~
